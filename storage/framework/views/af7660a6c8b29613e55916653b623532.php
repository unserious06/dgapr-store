...
<?php endif; ?>
    <a href="<?php echo e(route('superadmin.admin.create')); ?>" class="btn btn-primary mb-3">Ajouter Admin</a>
        ...
        <tbody>
            <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('superadmin.admin.edit', $admin)); ?>" class="btn btn-warning">Modifier</a>
