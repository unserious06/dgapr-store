                    ...
                    <div class="card h-100 shadow-sm border-0">
                        <a href="<?php echo e(route('products.show', $product->slug)); ?>" class="text-decoration-none text-dark">
                            ...
                            <div class="card-body text-center d-flex flex-column justify-content-between">
                                <div>
                                    <h5 class="card-title mb-2"><?php echo e($product->title); ?></h5>
                                    <p class="text-primary fw-bold mb-0"><?php echo e($product->price); ?> MAD</p>
                                </div>
                            </div>
                        </a>
...
<?php endif; ?>
<?php /**PATH C:\Users\majim\OneDrive\Documents\dgapr-store\resources\views/products/index.blade.php ENDPATH**/ ?>