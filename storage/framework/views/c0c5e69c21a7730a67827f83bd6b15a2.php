...
<?php endif; ?>
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('home')); ?>" class="no-underline">
                        <span class="text-xl font-semibold text-gray-800 ml-3"><?php echo e(env('APP_NAME')); ?></span>
                    </a>
                </div>
...
<?php endif; ?>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <a href="<?php echo e(route('cart.index')); ?>" class="text-gray-600 hover:text-gray-800 relative">
                    ...
                    <div class="shopping">
                        ...
                        <span id="cart-count" class="quantity" style=" background: rgb(255, 255, 255);
                                                        ...
                                                        min-width: 18px;
                                                        height: 18px;
                                                        font-size: 12px;"><?php echo e($cartCount ?? 0); ?></span>
