...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Create Admin User')); ?>
...
<div class="container mt-4">
    ...
    <form action="<?php echo e(route('superadmin.admin.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\majim\OneDrive\Documents\dgapr-store\resources\views/superadmin/admin/create.blade.php ENDPATH**/ ?>